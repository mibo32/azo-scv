...
docker run --tty --volume ${HelmScanninFolder}:/tf --workdir /tf bridgecrew/checkov --directory /tf --output junitxml --output-file-path /tf > $HelmScanninFolder/Checkov-Report.xml
